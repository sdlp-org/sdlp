...
describe("SDLP Error Classes", () => {
    describe("DIDMismatchError", () => {
        it("should create error with correct message and code", () => {
            ...
            expect(error.message).toBe(`DID mismatch: sid='${sid}' does not match kid base DID='${kid}'`);
    ...
    describe("PayloadChecksumMismatchError", () => {
        it("should create error with correct message and code", () => {
            ...
            expect(error.message).toBe(`Payload checksum mismatch: expected=${expected}, actual=${actual}`);
    ...
    describe("LinkExpiredError", () => {
        it("should create error with correct message and code", () => {
            ...
            expect(error.message).toBe(`Link expired at ${new Date(expiration * 1000).toISOString()}`);
    ...
    describe("LinkNotYetValidError", () => {
        it("should create error with correct message and code", () => {
            ...
            expect(error.message).toBe(`Link not valid until ${new Date(notBefore * 1000).toISOString()}`);
    ...
    describe("UnsupportedCompressionError", () => {
        it("should create error with correct message and code", () => {
            ...
            expect(error.message).toBe(`Unsupported compression algorithm: ${compression}`);
    ...
    describe("DIDResolutionError", () => {
        it("should create error with correct message and code", () => {
            ...
            expect(error.message).toBe(`Failed to resolve DID '${didUrl}': ${reason}`);
