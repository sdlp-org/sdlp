        ...
        <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          >
            <path
              ...
              strokeWidth="2"
              d="M12 4v.01M12 20v.01M4 12h.01M20 12h.01M6.31 6.31l.01.01M17.69 17.69l.01.01M6.31 17.69l.01-.01M17.69 6.31l.01-.01"
            ></path>
          </svg>
        </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-orange-700">
                This demo <strong>executes shell commands</strong> from verified
                SDLP payloads to demonstrate the power and security implications
                of deep links. This shows why cryptographic verification is
                essential.
              </p>
            </div>
          </div>
