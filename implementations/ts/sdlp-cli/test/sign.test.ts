...
describe('sign command DID-centric workflow', () => {
  ...
  beforeEach(() => {
    ...
    const testDidDocument = {
      ...
      verificationMethod: [
        {
          ...
          controller:
            'did:key:z6Mkp7AVwvWxnsNDuSSbf19sgKzrx223WY95AqZyAGifFVyV',
          publicKeyJwk: {
            kty: 'OKP',
            crv: 'Ed25519',
            x: 'O2onvM62pC1io6jQKm8Nc2UyFXcd4kOmOsBIoYtZ2ik',
      ...
      authentication: [
        'did:key:z6Mkp7AVwvWxnsNDuSSbf19sgKzrx223WY95AqZyAGifFVyV#z6Mkp7AVwvWxnsNDuSSbf19sgKzrx223WY95AqZyAGifFVyV',
      ],
      assertionMethod: [
        'did:key:z6Mkp7AVwvWxnsNDuSSbf19sgKzrx223WY95AqZyAGifFVyV#z6Mkp7AVwvWxnsNDuSSbf19sgKzrx223WY95AqZyAGifFVyV',
      ],
    ...
    writeFileSync(
      testDidDocumentFile,
      JSON.stringify(testDidDocument, null, 2)
    );
